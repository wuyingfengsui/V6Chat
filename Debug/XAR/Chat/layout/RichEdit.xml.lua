...
function SetEnable(self, no)
	local edit = self:GetControlObject("edit")
	return edit:SetEnable(no)
end
...
function OnGetObjectText(self, fname, obj)
	local control = self:GetOwnerControl()

	local str, handled = control:FireExtEvent("OnGetObjectText", fname, obj)
